...
rec =  "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
       "<record xmlns=\"http://www.loc.gov/MARC21/slim\">\n" + 
        ...
        "<controlfield tag=\"001\">338541185</controlfield>\n" + 
        "<controlfield tag=\"004\">879649505</controlfield>\n" + 
        "<controlfield tag=\"005\">20140514215352.0</controlfield>\n" + 
...
response = client.WorldCatDeleteLocalBibRecord(:holdingLibraryCode => holdingLibraryCode, :schema => schema, :instSymbol => instSymbol, :xRecord => rec)
